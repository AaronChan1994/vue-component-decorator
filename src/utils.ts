...
export function mixins<T extends Class<any, void[]>[], C extends any, P extends any[]>(Base: Class<C, P>, ...classes: T): Mixed<[Class<C, P>, ...T]> {
    const C = class {
        constructor(...args: P) {
            const b = new Base(...args);
    ...
    for (let c of [Base, ...classes] as Class[]) {
        do {
            // static member
        ...
        } while (c != Object.getPrototypeOf(Object));
    }
    // console.log(C.prototype);
    return C as Mixed<[Class<C, P>, ...T]>;
}
